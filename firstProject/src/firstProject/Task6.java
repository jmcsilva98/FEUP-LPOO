...
public class Task6 {
	...
	public static void Second_Level() {
		...
		while(secondlevel[x-1][y] != "O" &&secondlevel[x-1][y]!="*" && secondlevel[x][y+1] != "O" && secondlevel[x][y+1] != "*"&& secondlevel[x+1][y] != "O" && secondlevel[x+1][y] != "*"&& secondlevel[x][y-1] != "O"&& secondlevel[x][y-1] != "*") {
			System.out.println("Please input the character commands (U/D/L/R)");
			...
			System.out.println(yAux);
			if (secondlevel[xAux][yAux]==" ") {
				secondlevel[xAux][yAux] = "*";
			}
			else if (secondlevel[xAux][yAux]=="K") {
				secondlevel[xAux][yAux]="$";
			}
			secondlevel[xO][yO]="O";
			print2ndLevel(secondlevel);
