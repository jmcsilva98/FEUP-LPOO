...
public class GameController {
    ...
    public void detectCollisionSquare(float delta) {
        ...
        for (SquareModel square : GameModel.getInstance().getSquares()) {
            if (!gameOver && square.getY() - 2.3 < GameModel.getInstance().snakeBalls.get(0).getY() && GameModel.getInstance().snakeBalls.get(0).getX() + 1.9 > square.getX() && GameModel.getInstance().snakeBalls.get(0).getX() < square.getX() + 1.9 && GameModel.getInstance().snakeBalls.get(0).getY() < square.getY()) {
                speed = 0;
    ...
    public void detectCollisionBalls(float delta){
        for (BallModel ball : GameModel.getInstance().getBalls()) {
            if (!gameOver && ball.getY() -0.2 < GameModel.getInstance().snakeBalls.get(0).getY() && ball.getX() < GameModel.getInstance().snakeBalls.get(0).getX() + 0.8 && GameModel.getInstance().snakeBalls.get(0).getX() < ball.getX() + 0.8 && GameModel.getInstance().snakeBalls.get(0).getY() < ball.getY()) {
    ...
    public void detectCollisionWalls(float delta) {
        for (WallModel wall : GameModel.getInstance().getWalls()) {
            if (!gameOver && wall.getX() + 1 <= GameModel.getInstance().snakeBalls.get(0).getX() && GameModel.getInstance().snakeBalls.get(0).getX()< wall.getX()+1&& wall.getY() <= GameModel.getInstance().snakeBalls.get(0).getY()+3 &&GameModel.getInstance().snakeBalls.get(0).getY()< wall.getY()+10) {
